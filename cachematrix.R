...
## makeCacheMatrix creates a placeholder for the cached value. 
...
## publicly is exposing just a vector with 4 functions: the 2 set/get pairs: set, get, setsolve, getsolve
...
## if the inverse of x was not calculated before, it will be calculated and then cached
## if it was calculated and cached, it will be returned without need for recalculation
